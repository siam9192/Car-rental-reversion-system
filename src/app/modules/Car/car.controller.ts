...
sendResponse(res,{statusCode:201,status:true,message:"Car created successfully",data:result})
})
...
const updateCar = catchAsync(async(req:Request,res:Response)=>{ 
  ...
  sendResponse(res,{statusCode:201,status:true,message:"Car updated successfully",data:result})
})
...
const getCarById = catchAsync(async(req:Request,res:Response)=>{ 
    ...
    if(!result){
    sendResponse(res,{statusCode:404,status:false,message:"No Data found",data:result})
    }

    sendResponse(res,{statusCode:201,status:true,message:"Car  retrieved successfully",data:result})
  })
